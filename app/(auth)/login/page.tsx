    ...
    >
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        >
          ...
          {/* Form — client form action handled via API route in production */}
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                ...
                <Link
                  ...
                  style={{ fontSize: 12, color: 'var(--forest-600)', textDecoration: 'none' }}
                >
                  Forgot?
                </Link>
              </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: 'var(--muted)', marginTop: 20 }}>
          ...
          <Link href="/register" style={{ color: 'var(--forest-700)', fontWeight: 600, textDecoration: 'none' }}>
            Sign up free
          </Link>
        </p>
      </div>
